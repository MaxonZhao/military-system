...
<body>
    <h2>Selection on Military Unit </h2>

    <form method="POST" action="Selection_page.php">
        <select name="muattri">
            <option value="MUID">MUID</option>
            <option value="Capacity">Capacity</option>
            <option value="CID">CID</option>
            <option value="Death">Death</option>
        </select>
        operator <input type="text" name="op"> value <input type="text" name="sval"> <br /><br />
        <input type="submit" value="Select" name="sub">
    </form>
    ...
    <form method="POST" action="Selection_page.php">
        ...
        <input type="submit" value="Display contents of MilitaryUnit" name="display_result"></p>
    </form>
    ...
    //         $c = $_POST['sval'];
    //         echo "<br>" . $a . $b . $c . "<br>";
    //         $query = "SELECT * FROM MilitaryUnit WHERE {$_POST['muattri']} {$_POST['op']} {$_POST['sval']}";
    ...
    if (isset($_POST['sub'])) {
        ...
        if (connectToDB()) {
            $result = executePlainSQL("SELECT * FROM MilitaryUnit");
            printResultMilitaryUnit($result);
            disconnectFromDB();
        }
