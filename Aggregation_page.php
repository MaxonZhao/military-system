...
<body>
    <h2>Aggregation query </h2>
        <form method="GET" action="Aggregation_page.php"> <!--refresh page when submitted-->
    ...
    <form method="POST" action="Aggregation_page.php"> <!--refresh page when submitted-->
            <input type="submit" value="Display Result" name="display_result"></p>
    </form>
