...
<body>
    <h2>Projection on Combatant </h2>
        <form method="GET" action="Projection_page.php"> <!--refresh page when submitted-->
    ...
    <form method="POST" action="Projection_page.php"> <!--refresh page when submitted-->
    ...
    function printCombatantSelectionTable($result, $namesOfColumnsArray) { //prints results from a select statement
        echo "<br>Retrieved data from table Combatant:<br>";
        echo "<table>";
        echo "<tr>";
