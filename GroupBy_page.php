...
<body>
    <h2>GroupBy </h2>
        <form method="GET" action="GroupBy_page.php"> <!--refresh page when submitted-->
    ...
    <form method="POST" action="GroupBy_page.php"> <!--refresh page when submitted-->
